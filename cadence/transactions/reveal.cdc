...
transaction(keys:[UInt64]) {
    ...
    prepare(user: auth(BorrowValue, LoadValue) &Account) {
...
// flow transactions send cadence/transactions/reveal.cdc --args-json '[{"type":"Array", "value":[{"type":"UInt64","value":"263882790666241"}]}]' --signer user1 --network emulator
